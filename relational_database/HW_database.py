...
def task_4_update_customer(con):
    ...
    with con.cursor() as con:
        con.execute("UPDATE customers SET customername = 'Johnny Depp' WHERE customerid = 1;")
...
def task_10_list_first_10_customers(cur):
    ...
    Results: 10 records
    """
    cur.execute("SELECT * FROM Customers WHERE customerid BETWEEN 1 AND 10;")
    return cur.fetchall()
...
def task_11_list_customers_starting_from_11th(cur):
    ...
    Returns: 11 records
    """
    cur.execute("SELECT * FROM Customers WHERE customerid NOT BETWEEN 1 AND 11;")
    return cur.fetchall()
...
def task_13_list_products_from_sweden_suppliers(cur):
    ...
    Returns: 3 records
    """
    cur.execute('''SELECT productname FROM products, suppliers
...
def task_14_list_products_with_supplier_information(cur):
    ...
    cur.execute('''SELECT products.productid, products.productname, products.unit, products.price, suppliers.country,
                   suppliers.city, suppliers.suppliername  FROM products, suppliers
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    ...
    Returns: 194 records
    """
    cur.execute('''SELECT customers.customername, customers.address, customers.country, suppliers.suppliername
                   FROM customers, suppliers WHERE customers.country = suppliers.country;''')
    return cur.fetchall()
